...
>(({ className, checked, indeterminate, ...props }, ref) => {
  return (
    <CheckboxPrimitive.Root
      ...
      ref={ref}
      className={cn(
        'border-foreground focus-visible:ring-ring peer h-4 w-4 shrink-0 rounded-sm border shadow focus-visible:outline-none focus-visible:ring-1 disabled:cursor-not-allowed disabled:opacity-50 ',
